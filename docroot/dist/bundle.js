...
var _user$project$Utils$capitalize = function (name) {
	var rest = A2(_elm_lang$core$String$dropLeft, 1, name);
	var first = _elm_lang$core$String$toUpper(
		A2(_elm_lang$core$String$left, 1, name));
	return A2(_elm_lang$core$Basics_ops['++'], first, rest);
};
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(
					...
					'Hello ',
					_user$project$Utils$capitalize(model.name)))
			]));
};
...
Elm['Utils'] = Elm['Utils'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Utils'], 'Utils', typeof _user$project$Utils$main === 'undefined' ? null : _user$project$Utils$main);
